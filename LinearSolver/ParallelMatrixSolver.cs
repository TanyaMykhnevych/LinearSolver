...
{
    public static class ParallelMatrixSolver
    {
        ...
        private static void CalculateEachColumn(double[][] result, int n, int[] perm, int toggle)
        {
            Parallel.For(0, n - 1, j => // each column
            {
